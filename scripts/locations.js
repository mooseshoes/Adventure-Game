			...
			var gameLocation1 = new gameLocation(1,false,null,null,gameLocation0,null,"Gold Ring",127,46,"#616b65","You have entered the swamp.  There's a strong stench of death and decay.  The trees are all covered in fungi, and large mushrooms are growing all over the land along the stagnant water.");
			var gameLocation2 = new gameLocation(2,false,null,gameLocation1,null,null,null,91,46, "#7c5768","You have entered the wastelands.  The land is filled with ashes, and you are overwhelmed by the strong smell given off by the burning brimstone.");
			...
			var gameLocation4 = new gameLocation(4,false,null,null,null,gameLocation1,null,166,46,"#6b5076","You have entered the graveyard.  It appears to have been abandoned long ago, most of the grave markers are broken and the inscriptions have faded.");			
			...
			var gameLocation8 = new gameLocation(8,false,gameLocation5,null,null,null,null,190,137,"#a24ad3","You pass through a small tunnel and end up in a strange land.  The dirt is a strange shade of purple and the plants are like none you have ever seen.  This land seems almost otherworldly, maybe that tunnel acts as a portal between two different worlds.");			
			...
			var gameLocation12 = new gameLocation(12,false,null,gameLocation9,null,null,null,89,164,"#7f9295","You have entered the cave, it's very damp as smells of rotting vegetation.  Your face is barraged by water droplets as they come down from the stalactites.  There is very little light coming from the cave entrance, you're not sure how deep the cave goes. ");			
			var gameLocation13 = new gameLocation(13,false,null,gameLocation0,null,null,"Amulet",66,106,"#ad2626","You have entered the mountain.  A steep, treacherous mountain pass winds up the eastern side, what is to be found on the other side of the mountain you do not know.  The path looks like it hasn't been used in decades, and certain parts of the path have crumbled making it only 1 foot wide at some points, leading to a sudden and deadly drop.");
			var gameLocation14 = new gameLocation(14,false,gameLocation13,null,null,null,null,66,134,"#d0fad0","You have entered the peninsula.  The peninsula is about 12 feet above sea level, with a rocky dropoff around the edges.  The unrelenting sea waves bash against the rocky coast, and hard rain drenches the land.  As the rain washes the soil away, a nearby tree suddenly lurches forward, some of its deeper roots just barely preventing it from falling into the sea.");
			var gameLocation15 = new gameLocation(15,false,null,gameLocation13,null,null,null,28,106,"#ecc03c","You have entered the plateau.  There's a stream coming from the nearby mountain which dwarfs the plateau in comparison.  The stream crosses the top of the platuea from the eastern side to the northern side, and there it turns into a waterfall.  At the base of the waterfall you can see the stream continues going north-east.");
